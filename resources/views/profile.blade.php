<x-app-layout>
        ...
        <header>
              ...
              <div class="grid grid-cols-5 gap-4">
                    ...
                    <div class="col-start-2 col-span-1 flex justify-center w-auto mt-5">
                      <img alt="{{$profile->username}}" class="w-40 h-40 rounded-full" 
                    ...
                    <div class="col-start-3 col-span-2 flex justify-start items-center w-auto m-0">
                      <div class="grid grid-rows-2">
                       ...
                       @if(Auth::user()!=null && Auth::user()->name==$profile->name)
                          ...
                          class="border border-solid border-gray-300 rounded-md py-0 px-5 me-16
                           whitespace-nowrap"> {{__('Edit Profile')}} </a>
                        ...
                        <li class="me-10 cursor-pointer"><a href="{{route('followers')}}"><span class="font-semibold"> {{$profile->followers()->count()}} </span> {{__('followers')}} </a></li>
                        <li class="me-10 cursor-pointer"><a href="{{route('following')}}"><span class="font-semibold">{{$profile->follows()->count()}}</span> {{__('following')}} </a></li>
                      </ul>
                      <p class="mb-1 font-black"> {{$profile->name}} </p>
                      <p> {{$profile->bio}} </p>
                      <p class="text-blue-500"><a href=" {{$profile->url}} "></a></p>
  ...
  <!--content in header paert of  profile-->
  ...
  <div class="max-w-4xl my-0 mx-auto">
   ...
   @else
   <div>
         <h1 class="text-center">{{__('This account id private')}}</h1>
