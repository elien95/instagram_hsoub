<x-app-layout>
      ...
      <div class="grid grid-cols-12 mt-7 gap-4">
            <div class="col-start-3 col-span-5">
                  ...
                  <a href="/{{$post->user->username}}" class="hove:underline">
                        /{{$post->user->username}}</a> 
                  </div> 
                  <div>
                       <a href="/posts{{$post->id}}">
                  <img src="/storage/{{$post->image_path}}" class="w-full">
                  </a> 
                  </div>  
                  <div class="lex flex-row items-center mt-2">
                ...
                @endif
                  ...
                  <div class="flex flex-row items-center justify-between">
                        <input class="w-full outline-none border-none p-0" type="text" 
                  ...
                  @empty
                      <div class="m-10">
                            <p class="font-semibold">
                                  {{__('Start your jurney , follow your friends!')}}
                            </p>
                      </div>
                  @endforelse
